...
Quality Of Life:
	...
	- Added and renamed context.bar.png (default context.png image, copy this when you want to swap back to the original and rename to context.png)
	- Added and renamed context_more_default.png (default context_more.png image, copy this when you want to swap back to the original and rename to context_more.png)
	- Added context_more_clippy.png
	- Added context_more_noclippy.png (removes clippy from where i moved him due to no space)
  	- Added and renamed bg_audioplayer_black.png (default bg_audioplayer.png image, copy this when you want to swap back to the original and rename to bg_audioplayer.png)
	- Added bg_audioplayer_98.png (alternate bg for media player, does require a text color swap to something other than white!)
